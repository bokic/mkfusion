...
// Line 115.
        m_TemplateInstance->m_VARIABLES[L"TMP"] = cf_ArrayNew(QWDDX(1));
...
// Line 306.
        m_TemplateInstance->m_VARIABLES[L"DIVIDER"] = QWDDX(1);

// Line 328.
        m_TemplateInstance->m_VARIABLES[L"POSITIVESIGN"] = QWDDX(true);
