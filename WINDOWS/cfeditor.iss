...
VersionInfoDescription=ColdFusion Editor(Qt 4.6.2)
...
; MinGW runtime
Source: "c:\Qt\4.6.2\bin\libgcc_s_dw2-1.dll"; DestDir: "{app}";
Source: "c:\Qt\4.6.2\bin\mingwm10.dll"; DestDir: "{app}";

; QT library
Source: "c:\Qt\4.6.2\bin\QtCore4.dll"; DestDir: "{app}";
Source: "c:\Qt\4.6.2\bin\QtGui4.dll"; DestDir: "{app}";
Source: "c:\Qt\4.6.2\bin\QtNetwork4.dll"; DestDir: "{app}";
