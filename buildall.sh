...
mkdir install/ubuntu/mkfusion/etc/apache2/mods_available
...
cp install/ubuntu/mkfusion_mkfusion.conf install/ubuntu/mkfusion/etc/apache2/mods_available/mkfusion.conf
cp install/ubuntu/mkfusion_mkfusion.load install/ubuntu/mkfusion/etc/apache2/mods_available/mkfusion.load
